...
class ScrapeService {
    ...
    async accessWeb() {
        ...
        try {
            // Make the request
            const response = await rp.get('http://wipopublish.ipvietnam.gov.vn/wopublish-search/public/' + this.tab + '?&query=*:*', {
                headers: {
    ...
    async nextPage() {
        ...
        const  url="http://wipopublish.ipvietnam.gov.vn/wopublish-search/public/designs?0-1.IBehaviorListener.0-body-searchResultPanel-resultWrapper-dataTable-bottomToolbars-toolbars-2-span-navigator-next&query=*:*&_=1705991321860";
        console.log("url: "+ url)
    ...
    async accessWeb2() {
        ...
        const headers = {
            ...
            'Cookie': this.createCookieString(),
            'Origin': 'http://wipopublish.ipvietnam.gov.vn',
